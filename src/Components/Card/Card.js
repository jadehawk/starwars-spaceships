...
const Card = ({ picture, name, model, starship_class, consumables }) => {
  return (
    <div className='tc hashir tc dib br3 pa2 ma4 grow bw2 shadow-5'>
      <img alt='ships' className='br3 grow bw2 shadow-5' src={picture} />
      <div>
        <dl className="lh-title pt3 ph1 mt0">
          <dt className="f6 b">Picture</dt>
          <dd className="m10">{picture}</dd>
